...
public class HashMapHistogramTester  {
	public static void main(String[] args) {
		...
		stringHist.addItem("abc");
		stringHist.addItem("abc");
		stringHist.addItem("aabc");
		stringHist.addItem("z");
		stringHist.addItem("aa");
		Map.Entry<String, Integer> set= it.next();
		Map.Entry<String, Integer> set2= it.next();
		Map.Entry<String, Integer> set3=it.next();
		Map.Entry<String, Integer> set4= it.next();
		Map.Entry<String, Integer> set5= it.next();
		Map.Entry<String, Integer> set6= it.next();
		Map.Entry<String, Integer> set7= it.next();
